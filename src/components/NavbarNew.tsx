...
export function NavbarNew() {
  ...
  return (
    <motion.nav 
      className={`${isScrolled ? 'glass-effect-scrolled' : 'glass-effect'} shadow-elegant border-b border-gray-200/50 fixed top-0 left-0 right-0 z-50 rounded-b-3xl w-full max-w-full transition-all duration-300`}
