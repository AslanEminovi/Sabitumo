  ...
  return (
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ref={dropdownRef}
          className={`fixed top-16 left-1/2 transform -translate-x-1/2 w-screen max-w-5xl mx-4 bg-white border border-gray-200 rounded-lg shadow-xl z-[60] mt-1 ${className}`}
